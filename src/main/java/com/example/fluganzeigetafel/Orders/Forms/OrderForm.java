...
// Add columns for DISPO "BAGTR"
        ...
        res.ifPresent(result->{
            ...
            printButton.setOnAction(e->{
                ...
                if (Utility.fieldsAreEmpty(orderPane.getChildren())) {
                    ...
                    DataInterface.getInstance().statusBar.setText("Generating PDF for Order " + order.getAUKEY());
                    printer.createPDF(order);
                    DataInterface.getInstance().statusBar.setText("PDF successfully generated for Order " + order.getAUKEY());
                }
            ...
            showOrderStatisticsButton.setOnAction(e->{
                if (Utility.fieldsAreEmpty(orderPane.getChildren())) {
                    ...
                    DataInterface.getInstance().statusBar.setText("Statistical data about Order "+ order.getAUKEY() +" displayed");
                }
            ...
            generateSuborderButton.setOnAction(e->{
                ...
                if (Utility.fieldsAreEmpty(orderPane.getChildren())) {
                    ...
                    DataInterface.getInstance().statusBar.setText("Generated Suborderform");
                }
            ...
            deleteOrderButton.setOnAction(e-> {
                ...
                if (Utility.fieldsAreEmpty(orderPane.getChildren())) {
                    ...
                    FlightsTable.setOdsuComponent(null);
                    DataInterface.flightsTable.refresh();
                    DataInterface.getInstance().statusBar.setText("Deleted Order " + order.getAUKEY());
                } else{
                    ...
                    resultAction.ifPresent(c->{
                        if (c == ButtonType.OK) {
                            ...
                            BorderPane bp = (BorderPane) flightsTableScene.getRoot();
                            VBox flightsTableBox = (VBox) bp.getCenter();
                ...
                if (Utility.fieldsAreEmpty(orderPane.getChildren())) {
                    ...
                    if (allFieldsCorrect) {
                        ...
                        if (allFieldsCorrect) {
                            ...
                            alert.showAndWait();
                            DataInterface.getInstance().statusBar.setText("Order " + order.getAUKEY() + " successfully saved");
                        }
                    }
    ...
    public VBox createOrderForm(Order order) {
        ...
        showOrderStatisticsButton.setOnAction(e->{
            OrderStats orderStats = new OrderStats(DataInterface.getCurrentFlight().getOrders());
            DataInterface.getInstance().statusBar.setText("Statistical data about " + order.getAUKEY() + " displayed");
        ...
        generateSuborderButton.setOnAction(e->{
            ...
            FlightsTable.setOdsuComponent(box);
            DataInterface.getInstance().statusBar.setText("Suborderform successfully created");
        ...
        deleteOrderButton.setOnAction(e-> {
           ...
           result.ifPresent(c->{
               if (c == ButtonType.OK) {
                 ...
                 DataInterface.flightsTable.refresh();
                   DataInterface.getInstance().statusBar.setText("Order " + order.getAUKEY() + "successfully deleted");
