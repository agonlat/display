...
task.setOnSucceeded(e->{
    ...
    MainGraphicElements.filterTextField.setEditable(true);
    ...
    public static ObservableList<TreeItem<Flight>> copyTreeItems(ObservableList<TreeItem<Flight>> originalItems) {
