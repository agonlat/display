    ...
    public VBox createSubOrderForm(Suborder suborder, Order order) {
        ...
        closeButton.setOnAction(e-> {
            if (CloseDialog.createCloseDialog()) {
                ...
                DataInterface.getInstance().statusBar.setText("Suborder " + suborder.getUAKEY() + "closed");
            } else {
        ...
        printButton.setOnAction(e->{
            if (Utility.fieldsAreEmpty(orderPane.getChildren())) {
                ...
                DataInterface.getInstance().statusBar.setText("Generating PDF for " + suborder.getUAKEY());
                Printer printer = new Printer();
                printer.createPDF(suborder);
                DataInterface.getInstance().statusBar.setText("PDF for" + suborder.getUAKEY() + " generated successfully");
            }
        ...
        showSubOrderStatisticsButton.setOnAction(e->{
            ...
            if (Utility.fieldsAreEmpty(orderPane.getChildren())) {
                ...
                DataInterface.getInstance().statusBar.setText("Statistical data about " + suborder.getUAKEY() + " displayed");
            }
        });
        ...
        deleteSubOrderButton.setOnAction(e-> {
          ...
          if (Utility.fieldsAreEmpty(orderPane.getChildren())) {
              ...
              VBox b = (VBox) bp.getCenter();
              b.getChildren().remove(FlightsTable.getOdsuComponent());
              DataInterface.getInstance().statusBar.setText("Deleted " + suborder.getUAKEY() + " successfully");
          } else {
        ...
        saveButton.setOnAction(e->{
            if (Utility.fieldsAreEmpty(orderPane.getChildren())) {
                ...
                if (allFieldsCorrect) {
                    ...
                    alert.showAndWait();
                    DataInterface.getInstance().statusBar.setText("Suborder " + suborder.getUAKEY() + " successfully saved");
    ...
    public VBox createSubOrderForm(Order order) {
        ...
        deleteSubOrderButton.setOnAction(e-> {
            ...
            if (Utility.fieldsAreEmpty(orderPane.getChildren())) {
                ...
                VBox b = (VBox) bp.getCenter();
                b.getChildren().remove(FlightsTable.getOdsuComponent());
                DataInterface.getInstance().statusBar.setText("Suborder " + suborder.getUAKEY() + " deleted");
